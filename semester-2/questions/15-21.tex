...
Существует два принципиально разных способа представления многомерных массивов:
\begin{enumerate}
...
В С++ (как и в C) встроенную поддержку имеют только многомерные массивы в формате <<row-major>>. Примеры:
