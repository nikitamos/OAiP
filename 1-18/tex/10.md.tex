\section{Символьные и Строковые константы, отличие от числовых
...
\begin{Shaded}
\begin{Highlighting}[]
\AttributeTok{const} \DataTypeTok{char} \OperatorTok{*}\NormalTok{example\_string }\OperatorTok{=} \StringTok{"I am a string"}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\AttributeTok{const} \DataTypeTok{wchar\_t} \OperatorTok{*}\NormalTok{wide\_string }\OperatorTok{=} \StringTok{L"Я транслятор"}\OperatorTok{;}
\AttributeTok{const} \DataTypeTok{char8\_t} \OperatorTok{*}\NormalTok{utf8\_string }\OperatorTok{=} \StringTok{u8"Judgement!"}\OperatorTok{;}
\AttributeTok{const} \DataTypeTok{char16\_t} \OperatorTok{*}\NormalTok{utf16\_string }\OperatorTok{=} \StringTok{u"🐂"}\OperatorTok{;}
\AttributeTok{const} \DataTypeTok{char32\_t} \OperatorTok{*}\NormalTok{utf32\_string }\OperatorTok{=} \StringTok{U"Съешь же ещё этих мягких французских булок, да выпей чаю."}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DataTypeTok{char}\NormalTok{ a\_char }\OperatorTok{=} \CharTok{\textquotesingle{}A\textquotesingle{}}\OperatorTok{;}
\AttributeTok{const} \DataTypeTok{char} \OperatorTok{*}\NormalTok{a\_string }\OperatorTok{=} \StringTok{"A"}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
